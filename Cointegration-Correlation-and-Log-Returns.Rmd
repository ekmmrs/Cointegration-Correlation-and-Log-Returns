...
graphNtable <- function(top.sig, bot.sig, y_table, title){
  ...
  ggtable = annotation_custom(tableGrob(table,rows=NULL,cols=NULL), xmin = 130, ymin = y_table)
...
graphNtable(top, bot, y_table = 11.5, title = 'Perfect Cointegration, Perfect Correlation')
```
...
```{r, echo=FALSE, warning=FALSE, fig.align="center", fig.width=10,fig.height=6}
graphNtable(top, bot, y_table = 11.5, title = 'Perfect Cointegration, No Correlation')
```
...
```{r, echo=FALSE, warning=FALSE, fig.align="center", fig.width=10,fig.height=6}
graphNtable(top, bot, y_table = 39, title = 'No Cointegration, Strong Return Correlation')
```
...
```{r, echo=FALSE, warning=FALSE, fig.align="center", fig.width=10,fig.height=6}
graphNtable(top, bot, y_table = 10.75, title = 'Log, Pearson, and Spearman Comparison')
```
...
```{r, echo=FALSE, warning=FALSE, fig.align="center", fig.width=10,fig.height=6}
graphNtable(top, bot, y_table = 11.5, title = 'High Price Correlation, Low Return Correlation')
```
...
```{r, echo=FALSE, warning=FALSE, fig.align="center", fig.width=10,fig.height=6}
graphNtable(top, bot, y_table = 11.5, title = '')
```
